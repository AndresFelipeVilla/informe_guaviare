...
public class User {
    ...
    public User(UserId userId, String name, Email email, String passwordHash, String position, String department, Role role, BossCode code, User manager, Boolean active, LocalDateTime createdAt, LocalDateTime updateAt) {
        this.userId = userId;
        this.name = name;
        this.email = email;
    ...
    public static User createEmployee(String name, String email, String passwordHash, String position, String department, User manager) {
        ...
        return new User(null, name, Email.of(email), passwordHash, position, department, Role.EMPLEADO, null, manager, true, now, now);
    }

    public static User createBoss(String name, String email, String passwordHash, String position, String department, String bossCode) {
        if (name == null || name.trim().isEmpty()) {
            throw new DomainException("El nombre no puede ser nulo o vacío");
        }
        if (passwordHash == null || passwordHash.trim().isEmpty()) {
        ...
        LocalDateTime now = LocalDateTime.now();
        return new User(null, name, Email.of(email), passwordHash, position, department, Role.JEFE, BossCode.of(bossCode), null, true, now, now);
    }
